...
![提问栏输入问题有示例问题参考](figs/提问栏输入问题有示例问题参考.png)

*提问栏输入问题，系统提供示例问题参考*

### 智能回答与证据引用

![LLM智能回答](figs/LLM智能回答.png)

*LLM 基于知识图谱数据生成智能回答*

![LLM回答证据引用列表](figs/LLM回答证据引用列表.png)

*回答附带详细的证据引用列表，可追溯来源*

### 知识图谱可视化

![知识图谱数据库检索结果](figs/知识图谱数据库检索结果.png)

*数据库检索结果展示，支持展开查看详情*

![网页前端知识图谱查询可视化结果](figs/网页前端知识图谱查询可视化结果.png)

*使用 Cytoscape.js 进行知识图谱的可视化展示*

### 交互功能

![点击展开检索结果可以查看同类节点](figs/点击展开检索结果可以查看同类节点.png)

*点击展开检索结果可以查看同类节点*

![检索结果中可以查看节点详情](figs/检索结果中可以查看节点详情.png)

*在检索结果中查看节点详细信息*

![单击节点查看节点详情](figs/单击节点查看节点详情.png)

*在图谱可视化中单击节点查看详细信息和关联关系*

### 调试信息

![LLM输入输出调试信息查看](figs/LLM输入输出调试信息查看.png)

*可查看 LLM 输入输出和 GraphQL 查询的调试信息*

### 知识库管理界面

![节点管理](figs/节点管理.png)

*节点管理：查看、创建、编辑、删除节点，支持搜索、过滤和分页*

![关系管理](figs/关系管理.png)

*关系管理：查看、创建、编辑、删除关系，显示节点信息和方向*

## 数据源示例

### Neo4j 知识图谱

![neo4j数据库总体页面展示了药典的大纲节点](figs/neo4j数据库总体页面展示了药典的大纲节点.png)

*Neo4j 数据库展示了中国药典的大纲结构和各类节点*

![药品通则之间的关联引用](figs/药品通则之间的关联引用.png)

*药品通则之间复杂的关联引用关系*

### PostgreSQL 关系数据库

![2025药典全4部所有数据装进postgres数据库](figs/2025药典全4部所有数据装进postgres数据库.png)

*2025 版中国药典全 4 部数据存储在 PostgreSQL 中*
